...
public class VehicleTypeController {
    ...
    public ResponseEntity<ApiResponse<VehicleType>> update(@PathVariable String id,
        ...
        existing.setNameAr(vehicleType.getNameAr());
        existing.setDescription(vehicleType.getDescription());
        existing.setDescriptionAr(vehicleType.getDescriptionAr());
        return ResponseEntity.ok(ApiResponse.of(vehicleTypeRepository.save(existing)));
    }
